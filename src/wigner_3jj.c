...
//     allowed values of l1.  The size of `thrcof` must be at least
//     `l1max-l1min+1` and `thrcof[i]` will contain f(l1min+i), i=0, 1, ...,
//     l1max-l1min.  If `thrcof` is `NULL`, the function will return after
